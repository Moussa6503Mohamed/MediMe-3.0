...
export default function ProfileView() {
  ...
  const handleDeleteAccount = async () => {
    ...
    if (userToDelete) {
      try {
        // For simplicity, we are only deleting the main patient document.
        // A production app would use a Cloud Function to recursively delete subcollections.
        const userDocRef = doc(firestore, "patients", userToDelete.uid);
